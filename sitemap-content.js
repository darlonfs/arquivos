         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Clique para exibir os posts dessa categoria \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTable = '';
   var tocHead1 = 'Titulo';
   var tocTool1 = 'Clique para ordem alfabética';
   var tocHead2 = 'Data';
   var tocTool2 = 'Clique para organizar por data';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Exibindo as ' + postTitle.length + ' postagens<br/></span>'; }
   else {
